...
class ZoomitTabletsSpider(scrapy.Spider):
    name = 'zoomit_tablets'
    allowed_domains = ['www.zoomit.ir']
    start_urls = ['https://www.zoomit.ir/product/list/tablet/samsung/apple/']


    def parse(self, response):
        filename=open("zommit_tablets.txt","a")
